...
# ---------------------
test_dates = [
    list(map(dateutil.parser.parse, ['2012-10-22T00:00:00', '2012-10-31T00:00:00'])),  # peak at 2012-10-30T00:00:00 (ish)
]
print(test_dates)
...
test_dates = [
    list(map(dateutil.parser.parse, ['2012-10-25T00:00:00', '2012-10-31T00:00:00'])),  # peak at 2012-10-30T00:00:00 (ish)
]
print(test_dates)
